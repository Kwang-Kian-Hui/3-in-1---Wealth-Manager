...
class _$AuthStateTearOff {
  ...
  _Authenticated authenticated(User firebaseUser) {
...
class _$_Authenticated extends _Authenticated {
  const _$_Authenticated(this.firebaseUser) : super._();
...
abstract class _Authenticated extends AuthState {
  const factory _Authenticated(User firebaseUser) = _$_Authenticated;
